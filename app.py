...
# Configure Page
st.set_page_config(page_title="QuLab: Data Quality, Provenance & Bias Assessment for Enterprise AI Systems", layout="wide")
...
# Main Title Area
st.subheader("Pre-Deployment AI System Risk Audit: TransactionGuard AI")
st.caption("For Data Risk Lead, Sarah Chen (GlobalTrust Financial)")
